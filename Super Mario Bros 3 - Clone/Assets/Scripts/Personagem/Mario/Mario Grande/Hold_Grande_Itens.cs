...
public class Hold_Grande_Itens : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            HoldObject();
            animator.SetBool("isHold_GrandeItem", true);
        ...
        else if (!isHolding) // Quando não estiver segurando o objeto
        {
            ...
            animator.SetBool("isHold_GrandeItem", false);
        }
    ...
    private void ReleaseObject()
    {
        ...
        animator.SetBool("isKick_GrandeItem", true);
    ...
    private IEnumerator DisableKickAnimation()
    {
        ...
        animator.SetBool("isKick_GrandeItem", false);
    }
}
