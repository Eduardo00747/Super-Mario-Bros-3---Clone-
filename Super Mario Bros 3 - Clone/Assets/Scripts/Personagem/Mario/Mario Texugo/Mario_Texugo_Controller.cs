...
using UnityEngine;
using Cinemachine;
public class Mario_Texugo_Controller : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        bool isWalk_Texugo = Mathf.Abs(horizontalInput) > 0.1f;
        animator.SetBool("isWalk_Texugo", isWalk_Texugo);
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            canJump = true;
            animator.SetBool("isJump_Texugo", false);
        }
    }
    ...
    private void OnCollisionExit2D(Collision2D collision)
    {
        ...
        {
            canJump = false;
            animator.SetBool("isJump_Texugo", true);
        }
    }
}
