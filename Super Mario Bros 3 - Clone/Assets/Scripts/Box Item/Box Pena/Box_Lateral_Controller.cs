...
public class Box_Lateral_Controller : MonoBehaviour
{
    ...
    {
        if (collision.gameObject.CompareTag("Casco_Vermelho") && !isRecuando && !mecanicaExecutada)
        {
            // Obtém o primeiro ponto de contato
            ContactPoint2D contact = collision.contacts[0];

            // Verifica se o impacto foi lateral (mais na horizontal do que na vertical)
